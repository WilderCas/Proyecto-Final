...
class VentanaPrincipal:
    ...
    def ver_integrantes(self):
        ...
        texto += "===================================\n"
        texto += "1. Wilder Alfonso Castillo Salguero\n"
        texto += "   Carnet: 9490-21-3708\n"
        texto += "   Participación: 100%\n\n"
        texto += "2. Esdras Estuardo Pérez Villatoro\n"
        texto += "   Carnet: 9490-23-12626\n"
        texto += "   Participación: 100%\n\n"
